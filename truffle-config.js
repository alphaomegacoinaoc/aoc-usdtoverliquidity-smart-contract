...
//  const {apiKey,privateKey} = require('./secret.json');
...
module.exports = {
  ...
  networks: {
    ...
    // }
    testnet: {
      provider: () => new HDWalletProvider(privateKey, `https://speedy-nodes-nyc.moralis.io/f66f08702eda5dd11a7a603d/bsc/testnet`),
      network_id: 97,
      skipDryRun: true,
    ...
    // matic: {
    //   provider: () => new HDWalletProvider(privateKey, `https://speedy-nodes-nyc.moralis.io/f66f08702eda5dd11a7a603d/polygon/mumbai`),
    //   network_id: 80001,
    //   confirmations: 0,
    //   timeoutBlocks: 200,
    //   skipDryRun: true
